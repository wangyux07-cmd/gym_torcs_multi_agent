...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="TORCS Client Configuration")
    parser.add_argument("--port", type=int, default=3001, help="Port to connect to the TORCS server")
    args = parser.parse_args()

 
    print(f"Connecting to server on port: {args.port}")
    C = Client(p=args.port)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="TORCS AI Agent")
    parser.add_argument("--port", type=int, default=3001, help="Port to connect to the TORCS server")
    args = parser.parse_args()

  
    print(f"Agent launching on port: {args.port}")
    C = Client(p=args.port)
